...
def run_burst(filename, dnest_dir = "./", levelfilename=None, nsims=100):
    ...
    # this is to read in the data for X-ray lightcurves: CHANGE THIS
    ...
    ## run DNest
    # nice is smth that tells the machine to prioritize which process (?)
